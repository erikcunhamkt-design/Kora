...
7. **Dashboard Operacional Passivo**: Detalhado em [SUPABASE-OPERATIONAL-DASHBOARD.md](./SUPABASE-OPERATIONAL-DASHBOARD.md)
...
- Criação experimental a partir de oportunidades do CRM Supabase (se `kora.crm.supabaseCreateQuote.enabled` estiver ativa). Detalhado em [SUPABASE-CRM-QUOTE-CREATE.md](./SUPABASE-CRM-QUOTE-CREATE.md).
...
- Dashboard Operacional Passivo: Detalhado em [SUPABASE-OPERATIONAL-DASHBOARD.md](./SUPABASE-OPERATIONAL-DASHBOARD.md), permite consolidação de visibilidade de CRM, Orçamentos, Financeiro e Projetos sob a flag `kora.supabase.operationalDashboard.enabled`.
