...
**G75 — Central do Dia (`completeTask`) e lembretes (`useTaskReminders`) ficariam com no-op silencioso/loop de disparo pra tarefa só-nuvem, mesma classe G67/G73, aplicado por desenho ANTES de existir incidente. [BAIXO — confirmado e FECHADO preventivamente, mesma classe do G44/G56/G67/G73]**
