...
- **G33 em curso** (Lane A, ainda não mesclado em `origin/main` no momento desta rodada) — não referenciado por número/conteúdo por não ter tip confirmado ainda; se já estiver mesclado quando este doc for revisado, incorporar na próxima rodada de merge;
