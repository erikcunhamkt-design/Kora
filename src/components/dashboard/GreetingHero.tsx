      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-8 lg:gap-12 items-center">
        <div className="min-w-0">
          ...
          <p className="mt-3 text-[1rem] text-muted-foreground max-w-lg leading-relaxed">
            Seu cockpit está pronto. Veja o que precisa de atenção agora.
          </p>
          <div className="mt-6 flex flex-wrap items-center gap-2">
            <Button size="sm" variant="outline" onClick={openDay} className="gap-1.5 h-9">
        ...
        {nextAction && (
          <div className="relative rounded-xl border border-primary/25 bg-primary/[0.06] p-5 shadow-[0_0_40px_-12px_hsl(348_94%_52%_/_0.25)]">
            <div className="flex items-center gap-2 mb-3">
              <div className="h-7 w-7 rounded-md bg-primary/20 flex items-center justify-center">
                <Sparkles className="h-3.5 w-3.5 text-primary" />
              </div>
              <p className="text-[0.6875rem] uppercase tracking-[0.16em] font-semibold text-primary">
                Próxima melhor ação
              </p>
            </div>
            <p className="text-[1.0625rem] font-semibold text-foreground leading-snug">
              {nextAction.title}
            </p>
            <p className="mt-1.5 text-[0.875rem] text-muted-foreground leading-relaxed">
              {nextAction.reason}
            </p>
