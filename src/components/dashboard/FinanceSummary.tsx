...
export function FinanceSummary() {
  ...
  return (
    <div className="orbit-card p-5 animate-fade-up">
      <h3 className="text-sm font-semibold text-foreground mb-0.5">Resumo Financeiro</h3>
      <p className="text-[11px] text-muted-foreground mb-4">Faturamento vs Meta</p>
      <div className="flex items-baseline gap-2 mb-1">
        <span className="text-3xl font-bold text-foreground tracking-tight">R$ {revenue.toLocaleString("pt-BR")}</span>
      ...
      <div className="flex items-center justify-between mt-2">
        ...
        <span className="flex items-center gap-1 text-[11px] text-emerald-400 font-medium"><ArrowUpRight className="h-3 w-3" />+20% vs mês anterior</span>
      </div>
      <div className="grid grid-cols-3 gap-3 mt-4 pt-4 border-t border-divider">
        {[
